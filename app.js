function max(numbers) {
  let max = numbers[0]; //why start array as 0 array? are there no numbers preset in the array?
...
//help walking through the logic for max i dont get line 4 and 5


function min(numbers) {
  let min = numbers[0];
  for (let i = 0; i < numbers.length; i++) { //talk through logic here also why still increasing not decreasing?
    if (numbers[i] < min) {
      min = numbers[i];
    }
  }
